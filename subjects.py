...
try:
    ...
    # Only modify students table to auto-increment studid starting from 1000
    # Do NOT modify subjects table to auto-increment
    try:
        ...
        pass  # Table might already be modified
